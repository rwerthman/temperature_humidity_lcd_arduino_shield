...
//  timestamp = millis() - timestamp;
  ...
  const float tempFahrenheit = (temp.temperature * 1.8) + 32;

  lcd.print("Temp: "); lcd.print(tempFahrenheit); lcd.print(" F");

  // move the cursor to the second line
  lcd.setCursor(0, 1);

  lcd.print("Humidity: "); lcd.print(humidity.relative_humidity); lcd.println("% rH");
